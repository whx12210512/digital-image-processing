...
v2.0.5 收窄了最后的主要差距：QR 曲率搜索 5→13 值，碎片提取（edge_tear），更宽的自适应阈值覆盖，med3+CLAHE 组合。

| 类别 | Python | v2.0.4 App | v2.0.5 App | 提升 | 差距 |
|------|:------:|:----------:|:----------:|:----:|:----:|
| geometric_curved | 96.4% | 70.0% | **72.7%** | +2.7% | -23.7%¹ |
| barcode_cylinder | 94.5% | 92.7% | **92.7%** | — | -1.8% |
| barcode_geometric | 91.8% | 84.5% | **85.5%** | +1.0% | -6.3% |
| ink_data_pollution | 100% | 63.8% | **77.6%** | +13.8% | -22.4%¹ |
| ink_corner_destruction | 93.9% | 93.2% | **90.5%** | -2.7% | -3.4% |
| damage_noise | 81.8% | 68.2% | **85.5%** | +17.3% | +3.7% |
| edge_tear | 82.7% | 48.2% | **84.5%** | **+36.3%** | +1.8% |
| **平均** | **91.6%** | **74.4%** | **84.1%** | **+9.8%** | **-7.5%** |

> ¹ 差距主要来自解码器能力（pyzbar/zbar > BarcodeDetector+jsQR），预处理已到位。
